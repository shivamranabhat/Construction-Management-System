            ...
            <div class="border p-3 rounded mb-3">
                ...
                <div class="row g-2 mb-2">
                    ...
                    <div class="col-12 col-md-2 d-flex align-items-center">
                        ...
                        <div x-data="{ toggled: @entangle('mainBoqs.'.$index.'.subToggled') }"
                ...
                <div class="border-start mt-3 ps-3">
                    <div class="row g-2 mb-2">
                        <div class="col-md-2"><input type="number" wire:model.live="mainBoqs.{{ $index }}.subCount"
                                class="form-control" placeholder="No. of Sub BOQs"></div>
                        <div class="col-md-2"><button class="btn btn-secondary"
                                wire:click="generateSubBoqs({{ $index }})" type="button">Generate Sub BOQs</button>
                        </div>
                    </div>
