<div class="row row-sm">
    ...
    <div class="col-xl-4 col-md-6" x-data="{ openModal: false, activeBoqSlug: null }">
        <div class="card mb-4">
                            ...
                            <li class="list-group-item">
                                <div class="d-flex justify-content-between align-items-end">
                                    ...
                                    <div class="dropdown d-flex">
                                        ...
                                        <div class="dropdown-menu fs-13">
                                            <a class="dropdown-item" href="{{ route('boq.edit', $boq->slug) }}">Edit
                                                BOQ</a>
                                        ...
                                        <div x-show="openModal" class="modal-backdrop" style="display: none;">
                                            <div class="modal-box">
                                                <div class="modal-header p-0">
                                                    <div class="modal-title">Confirm Delete</div> <button
                                                        class="close-btn" @click="openModal = false">&times;</button>
                                                </div>
                                                <div class="modal-body"> Are you sure you want to delete? </div>
                                                <div class="modal-footer"> <button class="btn btn-cancel"
                                                        @click="openModal = false">Cancel</button> <button
                                                        class="btn btn-delete"
                                                        wire:click="delete('{{ $boq->slug }}')"
