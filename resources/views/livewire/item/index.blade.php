            ...
            <div class="table-responsive">
                <table class="table text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td x-data="{ openModal: false }">
                                <div class="hstack gap-2">
                                    <a href="{{ route('item.edit', $item->slug) }}"
                                    ...
                                    <div class="modal-box">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button class="btn btn-delete"
                                                wire:click="delete('{{ $item->slug }}')" @click="openModal = false">Delete</button>
                                        </div>
                                    </div>
                                </div>
                            </td>
                        ...
                        @empty
                        <tr>
                            <td colspan="4" class="text-center text-muted">No item found.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
