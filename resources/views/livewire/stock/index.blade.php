                ...
                <div class="card-body p-5">
                    <div class="mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor"
                            ...
                            <path
                                d="M8.186 1.113a.5.5 0 0 0-.372 0L1.846 3.5l2.404 1.45L8.186 3.5l3.937 1.45L14.5 3.5l-6.314-2.387ZM13.5 5.5l-2.5 1v5l2.5 1v-6Zm-1 6.5-2-1.2v-4.6l2 1.2v4.4ZM8.5 5.5l-2.5 1v5l2.5 1v-6Zm-1 6.5-2-1.2v-4.6l2 1.2v4.4ZM2.5 5.5l2.5 1v5l-2.5 1v-6Z" />
                        </svg>
                    </div>
                    <h3 class="text-dark mb-3">No Stock Records</h3>
                    <p class="text-muted mb-4">
                        Stock will appear here once you start making purchases.
                    </p>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="badge {{ $stock->stock > 0 ? 'bg-success' : 'bg-danger' }} fs-6">
                                        {{ $stock->stock }}
                                    </span>
                                </td>
                                <td>
